...
class LandlordHomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_landlord_home, container, false)
        init(view)
        return view
    }
    ...
    private fun init(view: View) {
        ...
        view.image_view_todo_list.setOnClickListener {
            startActivity(
                Intent(
                    context,
        ...
        view.image_view_properties.setOnClickListener {
            startActivity(
                Intent(
                    context,
