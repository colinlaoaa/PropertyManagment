...
import com.liao.propertymanagement.databinding.FragmentAddTodoListBinding
 ...
 * Use the [AddTodoListFragment.newInstance] factory method to
...
class AddTodoListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_add_todo_list,container,false)
    ...
    companion object {
         ...
         * @return A new instance of fragment AddTodoListFragment.
         */
