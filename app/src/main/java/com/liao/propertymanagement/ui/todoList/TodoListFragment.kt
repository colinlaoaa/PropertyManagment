...
import com.liao.propertymanagement.databinding.FragmentTodoListBinding
...
class TodoListFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            param1 = it.getSerializable(ARG_PARAM1) as TodoList
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(param1: TodoList, param2: String) =
